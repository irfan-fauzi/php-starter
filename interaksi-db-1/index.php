...
<body class="">
  <main class="shadow-md p-5 max-w-md w-full mx-auto mt-10">
    <h1 class="text-2xl text-center text-black mt-5">Register example form</h1>
    <div class="mt-5 p-5 max-w-md mx-auto">
      <form action="index.php" method="post"> 
        <div class=" flex flex-col gap-2">
          ...
          <button type="submit" class="border cursor-pointer bg-blue-500 text-white py-2 px-4 rounded">Register</button>
        </div>
      </form>
    </div>
    <?php
    ...
    if(isset($_POST['username']) && isset($_POST['password'])){
      ...
      $addUser = "INSERT INTO users (username, password) VALUES ('$username', '$passHashed')";
